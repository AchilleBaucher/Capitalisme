...
Pageprincipale.maxsize (width=928,height=589)
Pageprincipale.minsize (width=928,height=589)
...
Frame2 = Frame(Pageprincipale, borderwidth=2, relief=GROOVE)
Frame3 = Frame(Frame2, bg="white", borderwidth=2, relief=GROOVE)

#Fond
canvas = Canvas(Frame2,width=728, height=589)
...
for i in range(0,len(Villes)):
    ...
    if h!=0:
        ...
        if h > 1:
            canvas.create_text(Emplacementx, Emplacementy,text=h,fill = 'red')
        
    nomVille2 = Villes[i][1]
    p = DictQuick[nomVille2]
    #for k  in DictQuick:        
    ...
    if p!= 0:
        ...
        Emplacementx = random.randint(xhaut, xbas)
        Emplacementy = random.randint(yhaut, ybas)
        canvas.create_rectangle(Emplacementx, Emplacementy, Emplacementx+5, Emplacementy+5, fill = "green")    

        if p > 1:
            canvas.create_text(Emplacementx, Emplacementy,text=p,fill = 'green')
...
Frame2.pack(side=LEFT, padx=0, pady=0)
Frame3.pack(side=RIGHT, padx=5, pady=5)

v = StringVar(Frame3, "Nombre de McDo/ Quick :\n  ")
Label(Frame3, textvariable=v , bg="white").pack(padx=0, pady=0)
